...
import com.example.myandroidproject.core.ui.MovieAdapter
            ...
            if (it != null) {
                when (it) {
                    ...
                    is Resource.Success -> {
                        ...
                        if (listViewModel.getPage() == CommonConstant.PAGE_LIST_MOVIE) movieAdapter.clear()
                        movieAdapter.setData(it.data)
                        Toast.makeText(
                            this,
                            "Success get list movie data" + listViewModel.getPage().toString(),
                            Toast.LENGTH_LONG
                        )
                            .show()
                    }
